...
export default function MovieCard({ item, type = 'movie' }) {
  ...
  return (
    <>
      <div
        onClick={handleClick}
        className="group block rounded-xl overflow-hidden glass-morphism hover:shadow-2xl hover:shadow-red-500/20 transition-all duration-300 hover:scale-105 hover:-translate-y-1 cursor-pointer"
      >
